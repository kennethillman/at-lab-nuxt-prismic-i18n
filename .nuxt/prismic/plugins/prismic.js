...
export default async (context, inject) => {
  ...
  let api = await Prismic.api('https://at-lab-nuxt-prismic-i18n.cdn.prismic.io/api/v2', Object.assign({}, options,  {}))
  ...
  let prismic = new Vue({
    computed: {
      ...
      apiEndpoint() {
        return 'https://at-lab-nuxt-prismic-i18n.cdn.prismic.io/api/v2'
      },
      predicates() {
  ...
  if (process.client) {
    window.onNuxtReady && window.onNuxtReady(() => {
      ...
      script.src = '//static.cdn.prismic.io/prismic.min.js?repo=at-lab-nuxt-prismic-i18n&new=true'
  ...
  if (process.client && process.static && route.path !== '/preview') {
    ...
    const repo = 'at-lab-nuxt-prismic-i18n'
